...
/**
 * Custom filter for handling security and authentication in HTTP requests.
 */
@Component
public class SecurityFilter extends OncePerRequestFilter {
  ...
  /**
   * Performs the security filter for incoming HTTP requests.
   *
  ...
  /**
   * Retrieves the authentication token from the HTTP request.
   *
   * @param request The HTTP request.
